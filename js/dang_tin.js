document.addEventListener('DOMContentLoaded', () => {
    ...
    if (dangTinForm) {
        dangTinForm.addEventListener('submit', (e) => {
            ...
            const allValid = isTitle && isCategory && isBrand
                          && isCondition && isPrice && isLocation
                          && isDescription;
            ...
            if (allValid) {
                ...
                updatePreview(); // Reset khung preview về mặc định
            }
        });
    }
    ...
    function updatePreview() {
        ...
        const description = document.getElementById('description')?.value || 'Mô tả sản phẩm...';
    ...
    console.log("✅ [dang-tin.js] Loaded: Validate form sẵn sàng.");
});
